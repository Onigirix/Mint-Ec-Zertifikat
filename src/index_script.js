...
document.getElementById("manual").addEventListener("click", (event) => {
	...
	async function checkForAppUpdates() {
		...
		if (update === null) {
		  ...
		  const yes = await ask(`Update auf ${update.version} ist verfügbar!\n\nNeue Features: ${update.body}`, {
			title: 'Neues Update',
			kind: 'info',
			okLabel: 'Updaten',
